  ...
  return (
    <main className="min-h-screen bg-zinc-950 px-6 py-10 text-zinc-50">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
        <header className="flex flex-col gap-5 rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
          ...
          <nav className="flex flex-wrap gap-2 rounded-xl border border-zinc-800 bg-zinc-950/60 p-3">
            <p className="w-full px-1 text-xs uppercase tracking-[0.2em] text-zinc-500 sm:w-auto sm:self-center">
              Sekcje
            </p>

            <Link
              href={`/projects/${id}`}
              className="rounded-xl px-3 py-2 text-sm text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-100"
            >
              Przegląd
            </Link>
