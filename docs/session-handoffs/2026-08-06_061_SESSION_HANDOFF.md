...
Recommendation: Open Session 062 from the fresh package, run Project Integrity Check first, and then decide the next concrete MS-008.x application milestone.
