...
Blockers: NONE
Open Risks: NONE
Next Safe Step: Run `powershell -ExecutionPolicy Bypass -File .\scripts\New-SpsSession.ps1` after confirming the close commit is pushed and the repository is clean.
