...
Repository Branch: main
Repository Working Tree State: DIRTY - MS-034.3E implementation and publication sync changes are local and uncommitted
Ahead / Behind Status: 0 / 0
Latest Verified Commit: a2ee98f feat: add bcp registry detach preview
Verification Status: PASS
Blockers: NONE
Open Risks: NONE
